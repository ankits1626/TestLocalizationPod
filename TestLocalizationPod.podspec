Pod::Spec.new do |spec|
  ...
  spec.source_files = "TestLocalizationPod/*.{swift}", "TestLocalizationPod/**/*.{xib,png,jpg,jpeg,storyboard}", 'TestLocalizationPod/*.lproj/*.strings', 'TestLocalizationPod/**/*.lproj/*.strings'
